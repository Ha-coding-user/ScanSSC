...
from core.utils.semkitti import geo_scal_loss, sem_scal_loss, CE_ssc_loss, scan_loss
...
class OccHead(nn.Module):
    def __init__(
        ...
        self.half_occ_size = [s // 2 for s in occ_size]
        
        # voxel losses
        self.loss_voxel_ce_weight = self.loss_weight_cfg.get('loss_voxel_ce_weight', 1.0)
        self.loss_voxel_sem_scal_weight = self.loss_weight_cfg.get('loss_voxel_sem_scal_weight', 1.0)
        self.loss_voxel_geo_scal_weight = self.loss_weight_cfg.get('loss_voxel_geo_scal_weight', 1.0)
        self.loss_voxel_scan_weight = self.loss_weight_cfg.get('loss_voxel_scan_weight', 1.0)
    ...
    def forward(self, voxel_feats, img_metas=None, img_feats=None, gt_occ=None, gt_occ_1_2=None):
    ...
    def loss(self, output_voxels, target_voxels):
        ...
        loss_dict['loss_scan'] = self.loss_voxel_scan_weight * scan_loss(output_voxels, target_voxels)
        return loss_dict